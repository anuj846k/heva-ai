...
const svgContent = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 620" width="100%" height="100%">
  ...
  <!-- Background Canvas -->
  <rect width="1000" height="620" fill="#F8FAFC" rx="16" />
  
  <!-- Boundary Regions -->
  <rect x="25" y="25" width="280" height="570" fill="#FFFFFF" stroke="#E2E8F0" stroke-width="2" rx="12" filter="url(#shadow)" />
  ...
  <rect x="330" y="25" width="340" height="570" fill="#FFFFFF" stroke="#E2E8F0" stroke-width="2" rx="12" filter="url(#shadow)" />
  ...
  <rect x="695" y="25" width="280" height="570" fill="#FFFFFF" stroke="#E2E8F0" stroke-width="2" rx="12" filter="url(#shadow)" />
  ...
  <g transform="translate(45, 410)">
    <rect width="240" height="150" fill="#EEF2F6" stroke="#E2E8F0" stroke-width="1" rx="8" />
    ...
    <text x="20" y="75" font-family="system-ui" font-size="11" fill="#475569">• Sandbox Iframe for Live HTML</text>
    <text x="20" y="95" font-family="system-ui" font-size="11" fill="#475569">• JSON Pretty Printer</text>
    <text x="20" y="115" font-family="system-ui" font-size="11" fill="#475569">• CSV Tabular Parser</text>
  </g>
  ...
  <g transform="translate(350, 230)">
    <rect width="300" height="190" fill="#F1F5F9" stroke="#0891B2" stroke-width="1.5" rx="8" />
    ...
    <text x="20" y="135" font-family="system-ui" font-size="11" fill="#334155">5. Loop steps or exit on target completion</text>
    <text x="20" y="155" font-family="system-ui" font-size="11" fill="#334155">6. Return final Markdown summary</text>
  </g>
  ...
  <g transform="translate(715, 360)">
    <rect width="240" height="200" fill="#F8FAFC" stroke="#E2E8F0" stroke-width="1" rx="8" />
    <rect x="0" y="0" width="240" height="30" fill="#E2E8F0" rx="8" />
    <text x="20" y="20" font-family="system-ui" font-size="12" font-weight="600" fill="#334155">Typed Agent Tools (tools.ts)</text>
    <text x="20" y="55" font-family="system-ui" font-size="11" fill="#0F172A">🔍 Exa API Search</text>
    <text x="20" y="75" font-family="system-ui" font-size="10" fill="#64748B">Real-time keyword internet search</text>
    <text x="20" y="105" font-family="system-ui" font-size="11" fill="#0F172A">📄 Exa Page Fetch</text>
    <text x="20" y="125" font-family="system-ui" font-size="10" fill="#64748B">Reads compact webpage markup texts</text>
    <text x="20" y="155" font-family="system-ui" font-size="11" fill="#0F172A">📍 Google Maps Embed API</text>
    <text x="20" y="175" font-family="system-ui" font-size="10" fill="#64748B">Renders responsive directions/places</text>
  </g>

  <!-- CONNECTING ARROWS -->
  <!-- Client SSE Listener <-> Server SSE Router -->
  <path d="M 350 125 L 285 125" stroke="#6B7280" stroke-width="1.5" stroke-dasharray="4 4" marker-end="url(#arrow)" />
  
  <!-- Client Controls <-> Server Interruption Router -->
  <path d="M 285 265 L 350 265" stroke="#6B7280" stroke-width="1.5" marker-end="url(#arrow)" />
  <path d="M 285 520 L 350 520" stroke="#6B7280" stroke-width="1.5" marker-end="url(#arrow)" />

  <!-- Server Runner <-> Client Trace Dashboard (Emitting SSE events) -->
  <path d="M 350 325 C 290 325, 290 145, 285 145" stroke="#0891B2" stroke-width="1.5" marker-end="url(#arrow)" fill="none" />
  
  <!-- Server Runner <-> DB -->
  <path d="M 650 310 L 715 145" stroke="#6B7280" stroke-width="1.5" marker-end="url(#arrow)" fill="none" />
  
  <!-- Server Runner <-> Gemini API -->
  <path d="M 650 275 L 715 275" stroke="#6B7280" stroke-width="1.5" marker-end="url(#arrow)" />
  
  <!-- Server Runner <-> Tools -->
  <path d="M 650 345 L 715 375" stroke="#6B7280" stroke-width="1.5" marker-end="url(#arrow)" />

  <!-- Document Card <-> Artifact Panel -->
  <path d="M 165 410 L 165 160" stroke="#4F46E5" stroke-width="1" stroke-dasharray="3 3" marker-end="url(#arrow)" fill="none" />
</svg>`;

fs.writeFileSync('public/flow.svg', svgContent, 'utf-8');
console.log('flow.svg created successfully');
